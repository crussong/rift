...
const DICE = (function() {
    ...
    function create_d10_geometry(radius) {
        // d10 geometry - NO triangular edge faces, NO chamfer
        ...
        // Only the 10 kite-shaped number faces
        var faces = [[5, 7, 11, 0], [4, 2, 10, 1], [1, 3, 11, 2], [0, 8, 10, 3], [7, 9, 11, 4],
                [8, 6, 10, 5], [9, 1, 11, 6], [2, 0, 10, 7], [3, 5, 11, 8], [6, 4, 10, 9]];
        
        // chamfer = 1.0 means no chamfer (sharp edges)
        return create_geom(vertices, faces, radius, 0, Math.PI * 6 / 5, 1.0);
    }
