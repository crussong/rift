/**
 * RIFT D&D 5e v3 — Character Creation Wizard
 * 13-step guided character creation + HP Roll modal.
 * Outputs to v3 S-format state (sheet-5e-v3.js).
 *
 * Depends on: sheet-5e-v3.js (S, defaultState, calc, render, save, migrateState)
 */
(function() {
'use strict';
...
function applyWizardData() {
    ...
    console.log('[5e-v3 Wizard] Character created:', S.name, 'Level', S.level, term(cls));
