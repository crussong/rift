...
// ========================================
// LAYOUT V2 - NEW NAVIGATION SYSTEM
// ========================================

/**
 * Create Top Navigation (V2)
 * User/Party/Room Dropdowns
 */
function createTopNavV2() {
    const userData = getUserData();
    const roomCode = localStorage.getItem('rift_current_room');
    ...
    <header class="topnav">
        <div class="topnav__inner">
            ...
            <div class="topnav__search">
                ...
                <input type="text" placeholder="Suchen..." id="globalSearchV2">
            </div>
            ...
            <div class="topnav__right">
                <!-- Party Dropdown -->
                <div class="topnav__dropdown-trigger" id="partyDropdownV2" style="display: ${hasRoom ? '' : 'none'};">
                    <div class="topnav__party">
                        <div class="topnav__party-avatars" id="partyAvatarsV2"></div>
                        <div class="topnav__party-info">
                            <span class="topnav__party-label">Party</span>
                            <span class="topnav__party-status" id="partyOnlineStatusV2">0 Online</span>
                        </div>
                    </div>
                    <div class="topnav__dropdown topnav__dropdown--party">
                        <div class="topnav__dropdown-header">
                            <div class="topnav__dropdown-title" id="partyRoomNameV2">Party</div>
                            <div class="topnav__dropdown-value" id="partyOnlineCountV2">0 online</div>
                        </div>
                        <div class="topnav__dropdown-body" id="partyMembersListV2"></div>
                    </div>
                </div>
                
                <!-- Room Code Dropdown -->
                <div class="topnav__dropdown-trigger" id="roomCodeDropdownV2" style="display: ${hasRoom ? '' : 'none'};">
                    <div class="topnav__room">
                        ...
                        <code id="roomCodeDisplayV2">${formattedCode}</code>
                    </div>
                    <div class="topnav__dropdown topnav__dropdown--room">
                        ...
                        <div class="topnav__dropdown-room-code">
                            <code id="roomCodeLargeV2">${formattedCode}</code>
                            <button class="topnav__dropdown-room-copy" title="Code kopieren" onclick="LayoutV2.copyRoomCode()">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>
                            </button>
                        </div>
                        <div class="topnav__dropdown-body">
                            <a href="#" class="topnav__dropdown-item" onclick="LayoutV2.shareRoomLink(); return false;">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><line x1="8.59" y1="13.51" x2="15.42" y2="17.49"/><line x1="15.41" y1="6.51" x2="8.59" y2="10.49"/></svg>
                                Link teilen
                            </a>
                            <div class="topnav__dropdown-divider"></div>
                            <a href="#" class="topnav__dropdown-item topnav__dropdown-item--danger" onclick="LayoutV2.leaveRoom(); return false;">
                ...
                <div class="topnav__divider" id="topnavDividerV2" style="display: ${hasRoom ? '' : 'none'};"></div>
                
                <!-- Notifications -->
                <button class="topnav__icon-btn" id="notificationsBtnV2">
                    ...
                    <span class="badge" id="notificationBadgeV2" style="display: none;"></span>
                </button>
                ...
                <div class="topnav__dropdown-trigger">
                    <div class="topnav__user" id="userDisplayV2">
                        <div class="topnav__user-avatar" id="userAvatarV2" style="background: ${userData.color};">
                            ${userData.avatar 
                                ? `<img src="${userData.avatar}" alt="">` 
                                : userData.initial
                            }
                        </div>
                        <span class="topnav__user-name" id="userNameV2">${userData.name}</span>
                    </div>
                    <div class="topnav__dropdown topnav__dropdown--user">
                        <div class="topnav__dropdown-user-header">
                            <div class="topnav__dropdown-user-avatar" id="userAvatarLargeV2" style="background: ${userData.color};">
                                ${userData.avatar 
                                    ? `<img src="${userData.avatar}" alt="">` 
                                    : userData.initial
                                }
                            ...
                            <div class="topnav__dropdown-user-info">
                                <div class="topnav__dropdown-user-name" id="userNameLargeV2">${userData.name}</div>
                                <div class="topnav__dropdown-user-email" id="userEmailV2"></div>
                            </div>
                        </div>
                        <div class="topnav__dropdown-body">
                            ...
                            <div class="topnav__dropdown-divider"></div>
                            <a href="#" class="topnav__dropdown-item topnav__dropdown-item--danger" onclick="LayoutV2.signOut(); return false;">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/></svg>
                                Abmelden
                            </a>
                        </div>
...
/**
 * Create Mega Navigation (V2)
 * Horizontal navigation with dropdowns
 */
function createMegaNavV2() {
    const currentPage = getCurrentPage();
    const userData = getUserData();
    const showGM = userData.isGM || userData.isCogm;
    
    // Active session info
    const activeSession = JSON.parse(localStorage.getItem('rift_active_session') || 'null');
    const hasActiveSession = activeSession && (activeSession.status === 'live' || activeSession.status === 'paused');
    
    return `
    <nav class="meganav">
        <div class="meganav__inner">
            <a href="index.html" class="meganav__item ${currentPage === 'index' ? 'active' : ''}" data-section="hub">
            ...
            <!-- Sessions Dropdown -->
            <div class="meganav__item meganav__item--dropdown ${currentPage === 'sessions' || currentPage === 'session' ? 'active' : ''}">
                ...
                <div class="meganav__dropdown">
                    <div class="meganav__dropdown-grid">
                        ...
                        <a href="session.html" class="meganav__dropdown-item" id="activeSessionLinkV2" style="display: ${hasActiveSession ? '' : 'none'};">
                            ...
                            <div class="meganav__dropdown-text">
                                ...
                                <span class="meganav__dropdown-desc" id="activeSessionNameV2">${activeSession?.name || 'Weiterspielen'}</span>
                            </div>
                        </a>
            ...
            <!-- Charaktere Dropdown -->
            <div class="meganav__item meganav__item--dropdown ${currentPage.startsWith('sheet') ? 'active' : ''}">
                ...
                <div class="meganav__dropdown">
                    <div class="meganav__dropdown-grid" id="characterDropdownGridV2">
                        <!-- Dynamisch befüllt -->
                    </div>
                </div>
            </div>
            ...
            <!-- Tools Dropdown -->
            <div class="meganav__item meganav__item--dropdown ${['dice', 'chat', 'notes', 'map', 'whiteboard'].includes(currentPage) ? 'active' : ''}">
            ...
            <!-- GM Center -->
            <a href="gm.html" class="meganav__item meganav__item--accent ${currentPage === 'gm' ? 'active' : ''}" id="gmCenterLinkV2" style="display: ${showGM ? '' : 'none'};">
...
/**
 * Create Bottom Dock (V2)
 * Mobile navigation
 */
function createDockV2() {
    const currentPage = getCurrentPage();
    
    // Get last character for dock link
    let characterLink = '#';
    try {
        const chars = JSON.parse(localStorage.getItem('rift_characters') || '[]');
        if (chars.length > 0) {
            ...
            characterLink = `${sheet}?id=${char.id}`;
        }
    } catch (e) {}
    ...
    <nav class="dock">
        <div class="dock__inner">
            <a href="index.html" class="dock__item ${currentPage === 'index' ? 'dock__item--active' : ''}" title="Hub">
                <svg viewBox="0 0 24 24" fill="currentColor"><path fill-rule="evenodd" clip-rule="evenodd" d="M2.5192 7.82274C2 8.77128 2 9.91549 2 12.2039V13.725C2 17.6258 2 19.5763 3.17157 20.7881C4.34315 22 6.22876 22 10 22H14C17.7712 22 19.6569 22 20.8284 20.7881C22 19.5763 22 17.6258 22 13.725V12.2039C22 9.91549 22 8.77128 21.4808 7.82274C20.9616 6.87421 20.0131 6.28551 18.116 5.10812L16.116 3.86687C14.1106 2.62229 13.1079 2 12 2C10.8921 2 9.88939 2.62229 7.88403 3.86687L5.88403 5.10813C3.98695 6.28551 3.0384 6.87421 2.5192 7.82274ZM9 17.25C8.58579 17.25 8.25 17.5858 8.25 18C8.25 18.4142 8.58579 18.75 9 18.75H15C15.4142 18.75 15.75 18.4142 15.75 18C15.75 17.5858 15.4142 17.25 15 17.25H9Z"/></svg>
            </a>
            <a href="sessions.html" class="dock__item ${currentPage === 'sessions' || currentPage === 'session' ? 'dock__item--active' : ''}" title="Sessions">
                <svg viewBox="0 0 24 24" fill="currentColor"><path d="M17 3h4a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h4V1h2v2h6V1h2v2zM4 9v10h16V9H4z"/></svg>
            </a>
            <a href="dice.html" class="dock__item dock__item--primary ${currentPage === 'dice' ? 'dock__item--active' : ''}" title="Würfeln">
                <svg viewBox="0 0 24 24" fill="currentColor"><path d="M5 3h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2zm2 4a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm10 10a1 1 0 1 0 0 2 1 1 0 0 0 0-2zM7 15a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm5-5a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm5-3a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"/></svg>
            </a>
            <a href="${characterLink}" class="dock__item ${currentPage.startsWith('sheet') ? 'dock__item--active' : ''}" title="Charakter" id="dockCharacterLinkV2">
                <svg viewBox="0 0 24 24" fill="currentColor"><path d="M20 22H4v-2a5 5 0 0 1 5-5h6a5 5 0 0 1 5 5v2zm-8-9a6 6 0 1 1 0-12 6 6 0 0 1 0 12z"/></svg>
            </a>
            <a href="chat.html" class="dock__item ${currentPage === 'chat' ? 'dock__item--active' : ''}" title="Chat">
                <svg viewBox="0 0 24 24" fill="currentColor"><path d="M6.455 19L2 22.5V4a1 1 0 0 1 1-1h18a1 1 0 0 1 1 1v14a1 1 0 0 1-1 1H6.455z"/></svg>
            </a>
        </div>
    </nav>
    ...
    <footer class="footerv2">
        <div class="footerv2__inner">
            <div class="footerv2__main">
                <div class="footerv2__brand">
                    <a href="index.html" class="footerv2__logo">
                        <img src="assets/img/logo_rift.png" alt="RIFT">
                    </a>
                    <p class="footerv2__tagline">Dein digitaler Begleiter für Pen & Paper Abenteuer</p>
                </div>
                <div class="footerv2__links">
                    <div class="footerv2__column">
                        <h4 class="footerv2__heading">RIFT</h4>
                        <a href="about.html" class="footerv2__link">Über uns</a>
                        <a href="roadmap.html" class="footerv2__link">Roadmap</a>
                        <a href="donate.html" class="footerv2__link">Unterstützen</a>
                    </div>
                    <div class="footerv2__column">
                        <h4 class="footerv2__heading">Ressourcen</h4>
                        <a href="branding.html" class="footerv2__link">Branding</a>
                        <a href="worldsapart.html" class="footerv2__link">Worlds Apart</a>
                        <a href="contact.html" class="footerv2__link">Kontakt</a>
                    </div>
                    <div class="footerv2__column">
                        <h4 class="footerv2__heading">Rechtliches</h4>
                        <a href="privacy.html" class="footerv2__link">Datenschutz</a>
                        <a href="imprint.html" class="footerv2__link">Impressum</a>
                    </div>
                </div>
            </div>
            <div class="footerv2__bottom">
                <span class="footerv2__copyright">© 2025 RIFT. Mit ♥ für Rollenspieler.</span>
                <span class="footerv2__version">v2.5.0</span>
            </div>
        </div>
    </footer>
    `;
...
const LayoutV2 = {
    ...
    initCharacterDropdown() {
        const grid = document.getElementById('characterDropdownGridV2');
        if (!grid) return;
    ...
    initDropdowns() {
        ...
        document.addEventListener('click', (e) => {
            if (!e.target.closest('.topnav__dropdown-trigger') && !e.target.closest('.meganav__item--dropdown')) {
                document.querySelectorAll('.topnav__dropdown-trigger.open, .meganav__item--dropdown.open').forEach(el => {
        ...
        // MegaNav dropdowns (hover on desktop, click on mobile)
        document.querySelectorAll('.meganav__item--dropdown').forEach(item => {
            item.addEventListener('click', (e) => {
                if (window.innerWidth <= 768) {
                    e.preventDefault();
                    e.stopPropagation();
                    const wasOpen = item.classList.contains('open');
                    document.querySelectorAll('.meganav__item--dropdown.open').forEach(el => el.classList.remove('open'));
    ...
    async leaveRoom() {
        ...
        try {
            ...
            // Hide room UI
            const partyDropdown = document.getElementById('partyDropdownV2');
            const roomDropdown = document.getElementById('roomCodeDropdownV2');
            const divider = document.getElementById('topnavDividerV2');
            ...
            console.error('[LayoutV2] Error leaving room:', e);
        }
    },
    ...
    async signOut() {
        try {
            ...
            console.error('[LayoutV2] Error signing out:', e);
        }
    },
    ...
    async updateRoomUI() {
        const roomCode = localStorage.getItem('rift_current_room');
        if (!roomCode || !window.RIFT?.rooms?.getRoomMembers) return;
        ...
        try {
            ...
            // Update avatars
            const avatars = document.getElementById('partyAvatarsV2');
            if (avatars) {
                avatars.innerHTML = onlineMembers.slice(0, 3).map(m => `
            ...
            // Update status
            const status = document.getElementById('partyOnlineStatusV2');
            if (status) status.textContent = `${onlineMembers.length} Online`;
            
            // Update dropdown
            const count = document.getElementById('partyOnlineCountV2');
            if (count) count.textContent = `${onlineMembers.length} von ${members.length} online`;
            
            const list = document.getElementById('partyMembersListV2');
            if (list) {
            ...
            console.warn('[LayoutV2] Error updating room UI:', e);
        }
    }
};

/**
 * Initialize Layout V2
 * Call this at the start of each page
 */
function initLayoutV2(options = {}) {
    // Skip in GM popup mode
    const urlParams = new URLSearchParams(window.location.search);
    if (urlParams.get('gm') === 'true') {
        console.log('[LayoutV2] GM popup mode - skipping layout');
        return;
    }
    
    const { includeFooter = false } = options;
    
    console.log('[LayoutV2] Initializing...');
    ...
    if (app) {
        const mainContent = app.querySelector('.main__content');
        pageContent = mainContent ? mainContent.innerHTML : app.innerHTML;
    }
    ...
    container.innerHTML = `
        ...
        <main class="main main--v2">
            ...
            ${includeFooter ? createFooterV2() : ''}
        </main>
        ${createDockV2()}
    `;
    
    // Add body class for V2 styling
    body.classList.add('layout-v2');
    
    // Initialize components
    LayoutV2.initDropdowns();
    LayoutV2.initCharacterDropdown();
    
    // Update room UI if in room
    if (localStorage.getItem('rift_current_room')) {
        setTimeout(() => LayoutV2.updateRoomUI(), 500);
    }
    
    // Listen for storage changes
    window.addEventListener('storage', (e) => {
        if (e.key === 'rift_current_room' || e.key === 'rift_active_session') {
            window.location.reload();
        }
    });
    
    LayoutV2.initialized = true;
    console.log('[LayoutV2] Initialized');
}

// Export for use in pages
if (typeof module !== 'undefined' && module.exports) {
    module.exports = { createSidebar, createTopbar, createFooter, initLayout, createTopNavV2, createMegaNavV2, createDockV2, createFooterV2, initLayoutV2, LayoutV2 };
}
