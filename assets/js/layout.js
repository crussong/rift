        ...
        <footer class="footer">
            <div class="footer__top">
                ...
                <nav class="footer__links">
                    <a href="/about" class="footer__link">Über RIFT</a>
                    <a href="/branding" class="footer__link">Branding Guide</a>
                    <a href="/contact" class="footer__link">Kontakt</a>
                    <a href="/donate" class="footer__link">Spenden</a>
                </nav>
            </div>
            ...
            <div class="footer__bottom">
                ...
                <nav class="footer__legal">
                    <a href="/privacy" class="footer__link">Datenschutz</a>
                    <span class="footer__separator">|</span>
                    <a href="/imprint" class="footer__link">Impressum</a>
                </nav>
            </div>
        </footer>
    `;
...
function copyInviteLink() {
    const code = getRoomCode();
    if (code) {
        const link = `${window.location.origin}/join/${code.replace('-', '')}`;
