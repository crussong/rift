    ...
    const sidebarHTML = `
        ...
        <aside class="sidebar" id="sidebar">
            <div class="sidebar__header">
                <a href="/hub" class="sidebar__brand" id="sidebarBrand">
            ...
            <nav class="sidebar__nav">
                <div class="sidebar__section">
                    <a href="/hub" class="sidebar__link ${currentPage === 'index' ? 'active' : ''}" data-tooltip="Hub">
                    ...
                    <a href="/sessions" class="sidebar__link ${currentPage === 'sessions' ? 'active' : ''}" data-tooltip="Sessions">
                        <svg class="sidebar__link-icon" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <a href="/sheet" class="sidebar__link ${currentPage === 'sheet' || currentPage.startsWith('sheet-') ? 'active' : ''}" data-tooltip="Charakterbogen">
                        <svg class="sidebar__link-icon" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <a href="/dice" class="sidebar__link ${currentPage === 'dice' ? 'active' : ''}" data-tooltip="Würfel">
                        <svg class="sidebar__link-icon" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <a href="/map" class="sidebar__link ${currentPage === 'map' ? 'active' : ''}" data-tooltip="Karte">
                        <svg class="sidebar__link-icon" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <a href="/notes" class="sidebar__link ${currentPage === 'notes' ? 'active' : ''}" data-tooltip="Notizen">
                        <svg class="sidebar__link-icon" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                            <path d="M14,10V4.5L19.5,10M5,3C3.89,3 3,3.89 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V9L15,3H5Z"/>
                        </svg>
                    </a>
                    
                    <a href="/whiteboard" class="sidebar__link ${currentPage === 'whiteboard' ? 'active' : ''}" data-tooltip="Whiteboard">
                        <svg class="sidebar__link-icon" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <a href="/chat" class="sidebar__link ${currentPage === 'chat' ? 'active' : ''}" data-tooltip="Chat">
                        <svg class="sidebar__link-icon" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                ...
                <div class="sidebar__section">
                    <a href="/about" class="sidebar__link ${currentPage === 'about' ? 'active' : ''}" data-tooltip="Über RIFT">
                        <svg class="sidebar__link-icon" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <a href="/roadmap" class="sidebar__link ${currentPage === 'roadmap' ? 'active' : ''}" data-tooltip="Roadmap">
                        <svg class="sidebar__link-icon" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div class="sidebar__footer">
                ...
                <a href="/gm" class="sidebar__link sidebar__link--gm ${currentPage === 'gm' ? 'active' : ''}" data-tooltip="GM Optionen">
                    <svg class="sidebar__link-icon" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
    ...
    const topbarHTML = `
        <header class="topbar">
            ...
            <div class="topbar__icons">
                ...
                ${(userData.isGM || userData.isCogm) ? `
                <a href="/gm" class="topbar__icon-btn topbar__icon-btn--gm" title="GM Optionen">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <div class="topbar__user-wrapper">
                ...
                <div class="topbar__dropdown" id="userDropdownMenu">
                    ...
                    <a href="/settings" class="topbar__dropdown-item" style="text-decoration: none;">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <circle cx="12" cy="12" r="3"/>
                            <path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z"/>
                        </svg>
    ...
    const footerHTML = `
        <footer class="footer">
            ...
            <div class="footer__bottom">
                <p class="footer__copy">© 2025 RIFT · <a href="/privacy">Datenschutz</a> · <a href="/privacy">Nutzungsbedingungen</a> · <a href="/imprint">Impressum</a></p>
                <div class="footer__social">
                    <a href="https://discord.gg/de5zmanAMC" target="_blank" title="Discord">
...
function copyInviteLink() {
    const code = getRoomCode();
    if (code) {
        const link = `${window.location.origin}//login?room=${code.replace('-', '')}`;
 ...
 * @param {string} linkId - ID or href of the sidebar link (e.g., '/chat')
...
async function startAdventure() {
    ...
    if (upcomingSessions.length > 0) {
        // Go to next session
        window.location.href = `/session?id=${upcomingSessions[0].id}`;
    } else {
...
window.RIFTFab = {
    ...
    getSheetUrl() {
        ...
        const sheetMap = {
            ...
            'htbah': '/sheet/htbah',
            'cyberpunk': '/sheet/cyberpunk',
            'cyberpunkred': '/sheet/cyberpunk'
        };
        
        const sheetFile = sheetMap[char.system] || '/sheet';
...
const TopbarSessionStatus = {
    ...
    checkAndUpdate() {
        ...
        if (activeSession && (activeSession.status === 'live' || activeSession.status === 'paused')) {
            ...
            statusEl.href = `/session?id=${activeSession.id}`;
            ...
            <div class="topnav__row2-bg">
                <div class="topnav__row2">
                    <div class="topnav__menu">
                        <a href="/hub" class="topnav__menu-item ${currentPage === 'index' ? 'active' : ''}">
                            <svg viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <div class="topnav__social">
                        <a href="https://discord.gg/de5zmanAMC" target="_blank" class="topnav__social-link" title="Discord">
                            <svg viewBox="0 0 24 24" fill="currentColor">
...
function createBottomDock() {
    ...
    return `
        <div class="dock" id="bottomDock">
            <a href="/hub" class="dock__item ${currentPage === 'index' ? 'active' : ''}" data-tooltip="Hub">
                <svg viewBox="0 0 24 24" fill="currentColor">
                    <path d="M12.707 2.293l9 9c.63 .63 .184 1.707 -.707 1.707h-1v6a3 3 0 0 1 -3 3h-1v-7a3 3 0 0 0 -2.824 -2.995l-.176 -.005h-2a3 3 0 0 0 -3 3v7h-1a3 3 0 0 1 -3 -3v-6h-1c-.89 0 -1.337 -1.077 -.707 -1.707l9 -9a1 1 0 0 1 1.414 0m.293 11.707a1 1 0 0 1 1 1v7h-4v-7a1 1 0 0 1 .883 -.993l.117 -.007z"/>
                </svg>
            </a>
            ...
            ${(userData.isGM || userData.isCogm) ? `
            <div class="dock__divider"></div>
            <a href="/gm" class="dock__item dock__item--gm ${currentPage === 'gm' ? 'active' : ''}" data-tooltip="GM Optionen">
                <svg viewBox="0 0 24 24" fill="currentColor">
